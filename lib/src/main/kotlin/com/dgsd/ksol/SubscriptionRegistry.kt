...
internal class SubscriptionRegistry {
  ...
  private val transactionSignatureToRpcRequestIdMap =
    BidirectionalMap<TransactionSignature, String>()
  ...
  fun getSubscriptionIdFromSignature(transactionSignature: TransactionSignature): Long? {
    return transactionSignatureToRpcRequestIdMap.getFromKey(transactionSignature)
      ?.let { rpcRequestId ->
        rpcRequestIdToSubscriptionId.getFromKey(rpcRequestId)
      }
  }
